...
#if args.ssos: filePath = "/nfs/cms/vazqueze/analisisWW/hists/ssos/cuts/"
#else: filePath = "/nfs/cms/vazqueze/analisisWW/hists/cuts/"

if args.ssos: filePath = "/nfs/cms/vazqueze/analisisWW/hists/controlR/wjets/ssos/"
else: filePath = "/nfs/cms/vazqueze/analisisWW/hists/controlR/wjets/"

if args.ssos: ssos_add = "SSOS"
else: ssos_add = "" 

term = "wjetscr3_v1v2v3v4"
...
for name in histNames:
  ...
  samples = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","ttbar_charm","ttbarlep_charm","ttbarhad_charm","ttbar_nocharm","ttbarlep_nocharm","ttbarhad_nocharm","WZ","ZZ","ST1","ST2","ST3","ST4",
	...
	"Wjets7_charm","Wjets7_doublecharm","Wjets7_bottom","Wjets7_light","Wjets8_charm","Wjets8_doublecharm","Wjets8_bottom","Wjets8_light","DY1","DY2","DY3","DY4","DY5","DY6","DY7","DY8","QCD"]
  ...
  if args.stack:
    for s in samples:
      ...
      if args.linear: hS.SetMaximum(1.3*ymax)
  ...
  if args.ratio: 
    notation = "wjetscr3_v1v2v3v4_ratio_"
    if args.linear:
      notation = "wjetscr3_v1v2v3v4_linratio_"
  else: 
    notation = "wjetscr3_v1v2v3v4_normed_"
