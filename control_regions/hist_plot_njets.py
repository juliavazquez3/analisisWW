...
if args.sv:
  ...
  if args.ssos: filePath = "/nfs/cms/vazqueze/analisisWW/hists/controlR/ssos/"
  else: filePath = "/nfs/cms/vazqueze/analisisWW/hists/controlR/"

if args.ssos: ssos_add = "SSOS"
else: ssos_add = "" 

if args.sv: term = "sv_njet_v1v3v5"
else: term = "njet_v1v2v3v4"
...
histNamesSV.append("sv_jet_xy_M")
histNamesSV.append("sv_jet_xy_E")
histNamesSV.append("sv_jet_r_M")
histNamesSV.append("sv_jet_r_E")
...
for name in histNames:
  ...
  if args.jets:
    samples = ["WW_semi_charm","WW_semi_nocharm","WW_hadronic","WW_leptonic","ttbarT_nocharm","ttbarT_charm","WZ","ZZ","ST","DYJ","WjetsJ_charm","WjetsJ_doublecharm","WjetsJ_light","WjetsJ_bottom"]
  else:
  ...
  if args.stack:
    ...
    if (args.qcd and name[-1] == "M"): 
      ...
      if args.ssos:
         if name not in not_rebin: histT["QCD"].Rebin(5)
