...
## Modified version, meant to be run at condor, not completed, still with issues 
...
if args.process == "all": samples = ["WW","Wjets","ttbar"]
...
with open('/nfs/cms/vazqueze/analisisWW/routes/filesWW.txt') as f:
    lines = f.readlines()

files_WW = []
for line in lines:
    files_WW.append(line)

with open('/nfs/cms/vazqueze/analisisWW/routes/filesWjets.txt') as f:
    lines = f.readlines()

files_Wjets = []
for line in lines:
    files_Wjets.append(line)

with open('/nfs/cms/vazqueze/analisisWW/routes/filesttbar.txt') as f:
    lines = f.readlines()

files_ttbar = []
for line in lines:
    files_ttbar.append(line)

with open('/nfs/cms/vazqueze/analisisWW/routes/files2016.txt') as f:
    lines = f.readlines()

files_2016 = []
for line in lines:
    files_2016.append(line)

with open('/nfs/cms/vazqueze/analisisWW/routes/files2017.txt') as f:
    lines = f.readlines()

files_2017 = []
for line in lines:
    files_2017.append(line)

with open('/nfs/cms/vazqueze/analisisWW/routes/files2018.txt') as f:
    lines = f.readlines()

files_2018 = []
for line in lines:
    files_2018.append(line)
...
chain_ww =TChain("Events")
 
for file in files_WW:
    TFile.Open(file)
    chain_ww.Add(file)

#f = TFile.Open(files_WW[0]);

#df["WW"] = ROOT.RDataFrame("Events",f)
df["WW"] = ROOT.RDataFrame(chain_ww)

##df["Wjets"] = ROOT.RDataFrame("H2l2qEvents",set(files_Wjets))
##df["ttbar"] = ROOT.RDataFrame("H2l2qEvents",set(files_ttbar))

print(df["WW"].GetColumnNames())
