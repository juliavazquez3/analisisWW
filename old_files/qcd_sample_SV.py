...
for s in samples_data:
        ...
        df_data[s] = df_data[s].Define('JetSVInd','JetSVIndJet(nJet, JetGoodInd, Jet_pt, Jet_eta, Jet_phi, nSV, SV_pt, SV_phi, SV_eta)')
        df_data[s] = df_data[s].Define('SVJetInd','JetSVIndSV(nJet, JetGoodInd, JetSVInd, Jet_pt, Jet_eta, Jet_phi, nSV, SV_pt, SV_phi, SV_eta)')
        df_data[s] = df_data[s].Define('SVJetGood','svCond(SVJetInd, SV_pt, SV_eta, SV_charge)')
        df_data[s] = df_data[s].Define('SVLepSign','SSOS(MuonGoodInd, ElectronGoodInd, SVJetInd, Electron_charge, Muon_charge, SV_charge)')
        ...
        if args.ssos: df_data[s] = df_data[s].Define('weightSSOS','-1*SVLepSign/std::abs(SVLepSign)')
...
for s in samples_mc:
        ...
        df_mc[s] = df_mc[s].Define('JetSVInd','JetSVIndJet(nJet, JetGoodInd, Jet_pt, Jet_eta, Jet_phi, nSV, SV_pt, SV_phi, SV_eta)')
        df_mc[s] = df_mc[s].Define('SVJetInd','JetSVIndSV(nJet, JetGoodInd, JetSVInd, Jet_pt, Jet_eta, Jet_phi, nSV, SV_pt, SV_phi, SV_eta)')
        df_mc[s] = df_mc[s].Define('SVJetGood','svCond(SVJetInd, SV_pt, SV_eta, SV_charge)')
        df_mc[s] = df_mc[s].Define('SVLepSign','SSOS(MuonGoodInd, ElectronGoodInd, SVJetInd, Electron_charge, Muon_charge, SV_charge)')
        ...
        if args.ssos: df_mc[s] = df_mc[s].Define('weightSSOS','weight_aux*(-1)*SVLepSign/std::abs(SVLepSign)')
...
for s in samples_data:
	df_data[s] = df_data[s].Filter('nMuonGood<2 && nElectronGood<2').Filter('!(nMuonGood==1) != !(nElectronGood==1)').Filter('nJetGood==2').Filter('SVJetInd.size() >= 1').Filter('SVJetGood')
	df_data[s] = df_data[s].Filter('!(MuonJetInd.size() >= 1 && MuonJetGood)')
	df_data[s] = df_data[s].Define('JetnotSVInd','nJetGood>1 ? (JetSVInd[0] == JetGoodInd[0] ? JetGoodInd[1] : JetGoodInd[0]) : -1')
	df_data[s] = df_data[s].Define('SVmaxpTInd','std::distance(SV_pt.begin(),std::max_element(SV_pt.begin(),SV_pt.end()))')
	### hists definitions
	df_data[s] = df_data[s].Define('jet_muon_pt','Jet_pt[JetSVInd[0]]')
	df_data[s] = df_data[s].Define('jet_muon_nmu','Jet_nMuons[JetSVInd[0]]')
	df_data[s] = df_data[s].Define('jet_notmuon_pt','nJetGood>1 ? Jet_pt[JetnotSVInd] : 0')
	df_data[s] = df_data[s].Define('jet_muon_eta','Jet_eta[JetSVInd[0]]')
	df_data[s] = df_data[s].Define('jet_notmuon_eta','nJetGood>1 ? Jet_eta[JetnotSVInd] : 0')
	df_data[s] = df_data[s].Define('jet_notmuon_mass','nJetGood>1 ? Jet_mass[JetnotSVInd] : 0')
	df_data[s] = df_data[s].Define('jet_notmuon_qgl','nJetGood>1 ? Jet_qgl[JetnotSVInd] : 0')
	df_data[s] = df_data[s].Define('jet_notmuon_nmu','nJetGood>1 ? Jet_nMuons[JetnotSVInd] : 0')
	df_data[s] = df_data[s].Define('sv_jet_pt','SV_pt[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_eta','SV_eta[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_ntracks','SV_ntracks[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_mass','SV_mass[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_pangle','SV_pAngle[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_chi','SV_chi2[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_ndof','SV_ndof[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_charge','SV_charge[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_relpt','SV_pt[SVJetInd[0]]/Jet_pt[JetSVInd[0]]')
	df_data[s] = df_data[s].Define('sv_max_pt','SV_pt[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_eta','SV_eta[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_ntracks','SV_ntracks[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_mass','SV_mass[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_pangle','SV_pAngle[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_chi','SV_chi2[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_ndof','SV_ndof[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_charge','SV_charge[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('InvM_2jets','nJetGood>1 ? InvariantM(Jet_pt[JetSVInd[0]],Jet_eta[JetSVInd[0]],Jet_phi[JetSVInd[0]],Jet_mass[JetSVInd[0]],Jet_pt[JetnotSVInd],Jet_eta[JetnotSVInd],Jet_phi[JetnotSVInd],Jet_mass[JetnotSVInd]) : 0')
	df_data[s] = df_data[s].Define('deltaR_jetM_jetNM','nJetGood>1 ? ROOT::VecOps::DeltaR(Jet_eta[JetnotSVInd], Jet_eta[JetSVInd[0]] , Jet_phi[JetnotSVInd], Jet_phi[JetSVInd[0]])  : 10')
	df_data[s] = df_data[s].Define('deltaphi_jetM_jetNM','fabs(Jet_phi[JetSVInd[0]]-Jet_phi[JetnotSVInd])')
	df_data[s] = df_data[s].Define('deltaeta_jetM_jetNM','fabs(Jet_eta[JetSVInd[0]]-Jet_eta[JetnotSVInd])')
	df_data[s] = df_data[s].Define('deltapt_jetM_jetNM','fabs(Jet_pt[JetSVInd[0]]-Jet_pt[JetnotSVInd])')
	df_data[s] = df_data[s].Define('tracks_jetM','Jet_nConstituents[JetSVInd[0]]')
	df_data[s] = df_data[s].Define('tracks_jetNM','nJetGood>1 ? Jet_nConstituents[JetnotSVInd] : 0')
	df_data[s] = df_data[s].Define('EMN_jetM','Jet_neEmEF[JetSVInd[0]]')
	df_data[s] = df_data[s].Define('EMC_jetM','Jet_chEmEF[JetSVInd[0]]')
	df_data[s] = df_data[s].Define('EMtotal_jetM','Jet_chEmEF[JetSVInd[0]]+Jet_neEmEF[JetSVInd[0]]')
	...
	df_data[s] = df_data[s].Define('sv_jet_xy','SV_dxy[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_sigxy','SV_dxySig[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_r','SV_dlen[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_jet_sigr','SV_dlenSig[SVJetInd[0]]')
	df_data[s] = df_data[s].Define('sv_max_xy','SV_dxy[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_sigxy','SV_dxySig[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_r','SV_dlen[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('sv_max_sigr','SV_dlenSig[SVmaxpTInd]')
	df_data[s] = df_data[s].Define('pT_sum','pTsum(MuonGoodInd, ElectronGoodInd, JetSVInd, JetnotSVInd, Muon_pt, Muon_eta, Muon_phi, Muon_mass, Electron_pt, Electron_eta, Electron_phi, Electron_mass, MET_pt, MET_phi, Jet_pt, Jet_eta, Jet_phi, Jet_mass)')
	df_data[s] = df_data[s].Define('pT_product','pTprod(MuonGoodInd, ElectronGoodInd, JetSVInd, JetnotSVInd, Muon_pt, Muon_eta, Muon_phi, Muon_mass, Electron_pt, Electron_eta, Electron_phi, Electron_mass, MET_pt, MET_phi, Jet_pt, Jet_eta, Jet_phi, Jet_mass)')
	df_data[s] = df_data[s].Define('aux_various','variousSUM(MuonGoodInd, ElectronGoodInd, JetSVInd, JetnotSVInd, Muon_pt, Muon_eta, Muon_phi, Muon_mass, Electron_pt, Electron_eta, Electron_phi, Electron_mass, MET_pt, MET_phi, Jet_pt, Jet_eta, Jet_phi, Jet_mass)')
	...
	df_data[s] = df_data[s].Define('jet_muon_btag','Jet_btagDeepFlavB[JetSVInd[0]]')
	df_data[s] = df_data[s].Define('jet_notmuon_btag','Jet_btagDeepFlavB[JetnotSVInd]')

for s in samples_mc:
	df_mc[s] = df_mc[s].Filter('nMuonGood<2 && nElectronGood<2').Filter('!(nMuonGood==1) != !(nElectronGood==1)').Filter('nJetGood==2').Filter('SVJetInd.size() >= 1').Filter('SVJetGood')
	df_mc[s] = df_mc[s].Filter('!(MuonJetInd.size() >= 1 && MuonJetGood)')
	df_mc[s] = df_mc[s].Define('JetnotSVInd','nJetGood>1 ? (JetSVInd[0] == JetGoodInd[0] ? JetGoodInd[1] : JetGoodInd[0]) : -1')
	df_mc[s] = df_mc[s].Define('SVmaxpTInd','std::distance(SV_pt.begin(),std::max_element(SV_pt.begin(),SV_pt.end()))')
	### hists definitions
	df_mc[s] = df_mc[s].Define('jet_muon_pt','Jet_pt[JetSVInd[0]]')
	df_mc[s] = df_mc[s].Define('jet_muon_nmu','Jet_nMuons[JetSVInd[0]]')
	df_mc[s] = df_mc[s].Define('jet_notmuon_pt','nJetGood>1 ? Jet_pt[JetnotSVInd] : 0')
	df_mc[s] = df_mc[s].Define('jet_muon_eta','Jet_eta[JetSVInd[0]]')
	df_mc[s] = df_mc[s].Define('jet_notmuon_eta','nJetGood>1 ? Jet_eta[JetnotSVInd] : 0')
	df_mc[s] = df_mc[s].Define('jet_notmuon_mass','nJetGood>1 ? Jet_mass[JetnotSVInd] : 0')
	df_mc[s] = df_mc[s].Define('jet_notmuon_qgl','nJetGood>1 ? Jet_qgl[JetnotSVInd] : 0')
	df_mc[s] = df_mc[s].Define('jet_notmuon_nmu','nJetGood>1 ? Jet_nMuons[JetnotSVInd] : 0')
	df_mc[s] = df_mc[s].Define('sv_jet_pt','SV_pt[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_eta','SV_eta[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_ntracks','SV_ntracks[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_mass','SV_mass[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_pangle','SV_pAngle[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_chi','SV_chi2[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_ndof','SV_ndof[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_charge','SV_charge[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_relpt','SV_pt[SVJetInd[0]]/Jet_pt[JetSVInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_max_pt','SV_pt[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_eta','SV_eta[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_ntracks','SV_ntracks[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_mass','SV_mass[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_pangle','SV_pAngle[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_chi','SV_chi2[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_ndof','SV_ndof[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_charge','SV_charge[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('InvM_2jets','nJetGood>1 ? InvariantM(Jet_pt[JetSVInd[0]],Jet_eta[JetSVInd[0]],Jet_phi[JetSVInd[0]],Jet_mass[JetSVInd[0]],Jet_pt[JetnotSVInd],Jet_eta[JetnotSVInd],Jet_phi[JetnotSVInd],Jet_mass[JetnotSVInd]) : 0')
	df_mc[s] = df_mc[s].Define('deltaR_jetM_jetNM','nJetGood>1 ? ROOT::VecOps::DeltaR(Jet_eta[JetnotSVInd], Jet_eta[JetSVInd[0]] , Jet_phi[JetnotSVInd], Jet_phi[JetSVInd[0]])  : 10')
	df_mc[s] = df_mc[s].Define('deltaphi_jetM_jetNM','fabs(Jet_phi[JetSVInd[0]]-Jet_phi[JetnotSVInd])')
	df_mc[s] = df_mc[s].Define('deltaeta_jetM_jetNM','fabs(Jet_eta[JetSVInd[0]]-Jet_eta[JetnotSVInd])')
	df_mc[s] = df_mc[s].Define('deltapt_jetM_jetNM','fabs(Jet_pt[JetSVInd[0]]-Jet_pt[JetnotSVInd])')
	df_mc[s] = df_mc[s].Define('tracks_jetM','Jet_nConstituents[JetSVInd[0]]')
	df_mc[s] = df_mc[s].Define('tracks_jetNM','nJetGood>1 ? Jet_nConstituents[JetnotSVInd] : 0')
	df_mc[s] = df_mc[s].Define('EMN_jetM','Jet_neEmEF[JetSVInd[0]]')
	df_mc[s] = df_mc[s].Define('EMC_jetM','Jet_chEmEF[JetSVInd[0]]')
	df_mc[s] = df_mc[s].Define('EMtotal_jetM','Jet_chEmEF[JetSVInd[0]]+Jet_neEmEF[JetSVInd[0]]')
	...
	df_mc[s] = df_mc[s].Define('sv_jet_xy','SV_dxy[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_sigxy','SV_dxySig[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_r','SV_dlen[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_jet_sigr','SV_dlenSig[SVJetInd[0]]')
	df_mc[s] = df_mc[s].Define('sv_max_xy','SV_dxy[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_sigxy','SV_dxySig[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_r','SV_dlen[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('sv_max_sigr','SV_dlenSig[SVmaxpTInd]')
	df_mc[s] = df_mc[s].Define('pT_sum','pTsum(MuonGoodInd, ElectronGoodInd, JetSVInd, JetnotSVInd, Muon_pt, Muon_eta, Muon_phi, Muon_mass, Electron_pt, Electron_eta, Electron_phi, Electron_mass, MET_pt, MET_phi, Jet_pt, Jet_eta, Jet_phi, Jet_mass)')
	df_mc[s] = df_mc[s].Define('pT_product','pTprod(MuonGoodInd, ElectronGoodInd, JetSVInd, JetnotSVInd, Muon_pt, Muon_eta, Muon_phi, Muon_mass, Electron_pt, Electron_eta, Electron_phi, Electron_mass, MET_pt, MET_phi, Jet_pt, Jet_eta, Jet_phi, Jet_mass)')
	df_mc[s] = df_mc[s].Define('aux_various','variousSUM(MuonGoodInd, ElectronGoodInd, JetSVInd, JetnotSVInd, Muon_pt, Muon_eta, Muon_phi, Muon_mass, Electron_pt, Electron_eta, Electron_phi, Electron_mass, MET_pt, MET_phi, Jet_pt, Jet_eta, Jet_phi, Jet_mass)')
	...
	df_mc[s] = df_mc[s].Define('jet_muon_btag','Jet_btagDeepFlavB[JetSVInd[0]]')
	df_mc[s] = df_mc[s].Define('jet_notmuon_btag','Jet_btagDeepFlavB[JetnotSVInd]')
...
for s in samples_data:
	...
	df_data_muon[s] = df_data_muon[s].Define('deltaR_jetM_lepM','ROOT::VecOps::DeltaR(Muon_eta[MuonGoodInd[0]],Jet_eta[JetSVInd[0]] , Muon_phi[MuonGoodInd[0]], Jet_phi[JetSVInd[0]])')
	df_data_electron[s] = df_data_electron[s].Define('deltaR_jetM_lepE','ROOT::VecOps::DeltaR(Electron_eta[ElectronGoodInd[0]],Jet_eta[JetSVInd[0]] , Electron_phi[ElectronGoodInd[0]], Jet_phi[JetSVInd[0]])')
	df_data_muon[s] = df_data_muon[s].Define('InvM_jetM_lep', 'InvariantM(Jet_pt[JetSVInd[0]],Jet_eta[JetSVInd[0]],Jet_phi[JetSVInd[0]],Jet_mass[JetSVInd[0]],Muon_pt[MuonGoodInd[0]],Muon_eta[MuonGoodInd[0]],Muon_phi[MuonGoodInd[0]],Muon_mass[MuonGoodInd[0]])')
	df_data_electron[s] = df_data_electron[s].Define('InvM_jetM_lep', 'InvariantM(Jet_pt[JetSVInd[0]],Jet_eta[JetSVInd[0]],Jet_phi[JetSVInd[0]],Jet_mass[JetSVInd[0]],Electron_pt[ElectronGoodInd[0]],Electron_eta[ElectronGoodInd[0]],Electron_phi[ElectronGoodInd[0]], Electron_mass[ElectronGoodInd[0]])')
	...
	df_data_electron[s] = df_data_electron[s].Filter('sv_jet_ntracks > 2')
	df_data_muon[s] = df_data_muon[s].Filter('sv_jet_ntracks > 2')
	df_data_electron[s] = df_data_electron[s].Filter('sv_jet_sigr > 5')
	df_data_muon[s] = df_data_muon[s].Filter('sv_jet_sigr > 5')
...
for s in samples_mc:
	...
	df_mc_muon[s] = df_mc_muon[s].Define('deltaR_jetM_lepM','ROOT::VecOps::DeltaR(Muon_eta[MuonGoodInd[0]],Jet_eta[JetSVInd[0]] , Muon_phi[MuonGoodInd[0]], Jet_phi[JetSVInd[0]])')
	df_mc_electron[s] = df_mc_electron[s].Define('deltaR_jetM_lepE','ROOT::VecOps::DeltaR(Electron_eta[ElectronGoodInd[0]],Jet_eta[JetSVInd[0]] , Electron_phi[ElectronGoodInd[0]], Jet_phi[JetSVInd[0]])')
	df_mc_muon[s] = df_mc_muon[s].Define('InvM_jetM_lep', 'InvariantM(Jet_pt[JetSVInd[0]],Jet_eta[JetSVInd[0]],Jet_phi[JetSVInd[0]],Jet_mass[JetSVInd[0]],Muon_pt[MuonGoodInd[0]],Muon_eta[MuonGoodInd[0]],Muon_phi[MuonGoodInd[0]],Muon_mass[MuonGoodInd[0]])')
	df_mc_electron[s] = df_mc_electron[s].Define('InvM_jetM_lep', 'InvariantM(Jet_pt[JetSVInd[0]],Jet_eta[JetSVInd[0]],Jet_phi[JetSVInd[0]],Jet_mass[JetSVInd[0]],Electron_pt[ElectronGoodInd[0]],Electron_eta[ElectronGoodInd[0]],Electron_phi[ElectronGoodInd[0]], Electron_mass[ElectronGoodInd[0]])')
	...
	df_mc_electron[s] = df_mc_electron[s].Filter('sv_jet_ntracks > 2')
	df_mc_muon[s] = df_mc_muon[s].Filter('sv_jet_ntracks > 2')
	df_mc_electron[s] = df_mc_electron[s].Filter('sv_jet_sigr > 5')
	df_mc_muon[s] = df_mc_muon[s].Filter('sv_jet_sigr > 5')
...
for s in samples_data:
   if s[-1] == "M":
      ...
      hist_dataC_nSV_M = df_dataC_muon[s].Histo1D(("nSV_M","",10,0,10),"nSV","weightSSOS")
      hist_dataC_nMuoninJet_M = df_dataC_muon[s].Histo1D(("nMuoninJet_M","",10,0,10),"nMuoninJet","weightSSOS")
      hist_dataC_jet_muon_pt_M = df_dataC_muon[s].Histo1D(("jet_sv_pt_M","",50,20,120),"jet_muon_pt","weightSSOS")
      hist_dataC_jet_muon_nmu_M = df_dataC_muon[s].Histo1D(("jet_sv_nmu_M","",10,0,10),"jet_muon_nmu","weightSSOS")
      hist_dataC_jet_notmuon_pt_M = df_dataC_muon[s].Histo1D(("jet_not_sv_pt_M","",50,20,120),"jet_notmuon_pt","weightSSOS")
      hist_dataC_jet_muon_eta_M = df_dataC_muon[s].Histo1D(("jet_sv_eta_M","",80,-4,4),"jet_muon_eta","weightSSOS")
      hist_dataC_jet_notmuon_eta_M = df_dataC_muon[s].Histo1D(("jet_not_sv_eta_M","",80,-4,4),"jet_notmuon_eta","weightSSOS")
      hist_dataC_jet_notmuon_nmu_M = df_dataC_muon[s].Histo1D(("jet_notsv_nmu_M","",10,0,10),"jet_notmuon_nmu","weightSSOS")
      hist_dataC_jet_notmuon_mass_M = df_dataC_muon[s].Histo1D(("jet_notsv_mass_M","",40,0,40),"jet_notmuon_mass","weightSSOS")
      hist_dataC_jet_notmuon_qgl_M = df_dataC_muon[s].Histo1D(("jet_notsv_qgl_M","",100,0,1),"jet_notmuon_qgl","weightSSOS")
      ...
      hist_dataC_sv_jet_pt_M = df_dataC_muon[s].Histo1D(("sv_jet_pt_M","",50,0,25),"sv_jet_pt","weightSSOS")
      hist_dataC_sv_jet_eta_M = df_dataC_muon[s].Histo1D(("sv_jet_eta_M","",80,-4,4),"sv_jet_eta","weightSSOS")
      hist_dataC_sv_jet_mass_M = df_dataC_muon[s].Histo1D(("sv_jet_mass_M","",50,0,5),"sv_jet_mass","weightSSOS")
      hist_dataC_sv_jet_pangle_M = df_dataC_muon[s].Histo1D(("sv_jet_pangle_M","",50,1,3.5),"sv_jet_pangle","weightSSOS")
      hist_dataC_sv_jet_chi_M = df_dataC_muon[s].Histo1D(("sv_jet_chi_M","",50,0,20),"sv_jet_chi","weightSSOS")
      hist_dataC_sv_jet_ndof_M = df_dataC_muon[s].Histo1D(("sv_jet_ndof_M","",10,0,10),"sv_jet_ndof","weightSSOS")
      hist_dataC_sv_jet_charge_M = df_dataC_muon[s].Histo1D(("sv_jet_charge_M","",10,-5,5),"sv_jet_charge","weightSSOS")
      hist_dataC_sv_jet_ntracks_M = df_dataC_muon[s].Histo1D(("sv_jet_ntracks_M","",15,0,15),"sv_jet_ntracks","weightSSOS")
      hist_dataC_sv_jet_relpt_M = df_dataC_muon[s].Histo1D(("sv_jet_relpt_M","",50,0,1),"sv_jet_relpt","weightSSOS")
      hist_dataC_sv_max_pt_M = df_dataC_muon[s].Histo1D(("sv_max_pt_M","",50,0,25),"sv_max_pt","weightSSOS")
      hist_dataC_sv_max_eta_M = df_dataC_muon[s].Histo1D(("sv_max_eta_M","",80,-4,4),"sv_max_eta","weightSSOS")
      hist_dataC_sv_max_mass_M = df_dataC_muon[s].Histo1D(("sv_max_mass_M","",50,0,5),"sv_max_mass","weightSSOS")
      hist_dataC_sv_max_pangle_M = df_dataC_muon[s].Histo1D(("sv_max_pangle_M","",50,1,3.5),"sv_max_pangle","weightSSOS")
      hist_dataC_sv_max_chi_M = df_dataC_muon[s].Histo1D(("sv_max_chi_M","",50,0,20),"sv_max_chi","weightSSOS")
      hist_dataC_sv_max_ndof_M = df_dataC_muon[s].Histo1D(("sv_max_ndof_M","",10,0,10),"sv_max_ndof","weightSSOS")
      hist_dataC_sv_max_charge_M = df_dataC_muon[s].Histo1D(("sv_max_charge_M","",10,-5,5),"sv_max_charge","weightSSOS")
      hist_dataC_sv_max_ntracks_M = df_dataC_muon[s].Histo1D(("sv_max_ntracks_M","",15,0,15),"sv_max_ntracks","weightSSOS")
      hist_dataC_InvM_2jets_M = df_dataC_muon[s].Histo1D(("InvM_2jets_M","",100,0,300),"InvM_2jets","weightSSOS")
      hist_dataC_InvM_jetM_lep_M = df_dataC_muon[s].Histo1D(("InvM_jetM_lepM","",100,0,300),"InvM_jetM_lep","weightSSOS")
      hist_dataC_MET_M = df_dataC_muon[s].Histo1D(("MET_pt_M","",100,0,150),"MET_pt","weightSSOS")
      hist_dataC_deltaR_jetM_lep_M = df_dataC_muon[s].Histo1D(("deltaR_jetM_lepM","",100,0,5),"deltaR_jetM_lepM","weightSSOS")
      ...
      hist_dataC_tranverse_mass_M = df_dataC_muon[s].Histo1D(("transverse_massM","",50,0,150),"transverse_mass","weightSSOS")
      ...
      hist_dataC_sv_jet_sigxy_M = df_dataC_muon[s].Histo1D(("sv_jet_sigxy_M","",100,-4,4),"sv_jet_sigxy","weightSSOS")
      hist_dataC_sv_jet_sigr_M = df_dataC_muon[s].Histo1D(("sv_jet_sigr_M","",100,3,30),"sv_jet_sigr","weightSSOS")
      hist_dataC_sv_jet_xy_M = df_dataC_muon[s].Histo1D(("sv_jet_xy_M","",100,-4,4),"sv_jet_xy","weightSSOS")
      hist_dataC_sv_jet_r_M = df_dataC_muon[s].Histo1D(("sv_jet_r_M","",100,0,6),"sv_jet_r","weightSSOS")
      hist_dataC_sv_max_sigxy_M = df_dataC_muon[s].Histo1D(("sv_max_sigxy_M","",100,-4,4),"sv_max_sigxy","weightSSOS")
      hist_dataC_sv_max_sigr_M = df_dataC_muon[s].Histo1D(("sv_max_sigr_M","",100,3,30),"sv_max_sigr","weightSSOS")
      hist_dataC_sv_max_xy_M = df_dataC_muon[s].Histo1D(("sv_max_xy_M","",100,-4,4),"sv_max_xy","weightSSOS")
      hist_dataC_sv_max_r_M = df_dataC_muon[s].Histo1D(("sv_max_r_M","",100,0,6),"sv_max_r","weightSSOS")
      hist_dataC_SSOS_M = df_dataC_muon[s].Histo1D(("SSOS_M","",6,-3,3),"SVLepSign","weightSSOS")
      ...
      hist_dataC_jet_muon_btag_M = df_dataC_muon[s].Histo1D(("jet_sv_btag_M","",50,0,1),"jet_muon_btag","weightSSOS")
      hist_dataC_jet_notmuon_btag_M = df_dataC_muon[s].Histo1D(("jet_notsv_btag_M","",50,0,1),"jet_notmuon_btag","weightSSOS")
      hist_dataC_pT_proy_M = df_dataC_muon[s].Histo1D(("pT_proy_M","",100,-100,100),"pT_proy","weightSSOS")
      hist_dataC_pT_sum_2J_M = df_dataC_muon[s].Histo1D(("pT_sum 2J_M","",100,0,1),"pT_sum_2J","weightSSOS")

   if s[-1] == "E":
      hist_dataC_nJetGood_E = df_dataC_electron[s].Histo1D(("nJetGood_E","",10,0,10),"nJetGood","weightSSOS")
      hist_dataC_nSV_E = df_dataC_electron[s].Histo1D(("nSV_E","",10,0,10),"nSV","weightSSOS")
      hist_dataC_nMuoninJet_E = df_dataC_electron[s].Histo1D(("nMuoninJet_E","",10,0,10),"nMuoninJet","weightSSOS")
      hist_dataC_jet_muon_pt_E = df_dataC_electron[s].Histo1D(("jet_sv_pt_E","",50,20,120),"jet_muon_pt","weightSSOS")
      hist_dataC_jet_muon_nmu_E = df_dataC_electron[s].Histo1D(("jet_sv_nmu_E","",10,0,10),"jet_muon_nmu","weightSSOS")
      hist_dataC_jet_notmuon_pt_E = df_dataC_electron[s].Histo1D(("jet_not_sv_pt_E","",50,20,120),"jet_notmuon_pt","weightSSOS")
      hist_dataC_jet_muon_eta_E = df_dataC_electron[s].Histo1D(("jet_sv_eta_E","",80,-4,4),"jet_muon_eta","weightSSOS")
      hist_dataC_jet_notmuon_eta_E = df_dataC_electron[s].Histo1D(("jet_not_sv_eta_E","",80,-4,4),"jet_notmuon_eta","weightSSOS")
      hist_dataC_jet_notmuon_nmu_E = df_dataC_electron[s].Histo1D(("jet_notsv_nmu_E","",10,0,10),"jet_notmuon_nmu","weightSSOS")
      hist_dataC_jet_notmuon_mass_E = df_dataC_electron[s].Histo1D(("jet_notsv_mass_E","",40,0,40),"jet_notmuon_mass","weightSSOS")
      hist_dataC_jet_notmuon_qgl_E = df_dataC_electron[s].Histo1D(("jet_notsv_qgl_E","",100,0,1),"jet_notmuon_qgl","weightSSOS")
      ...
      hist_dataC_sv_jet_pt_E = df_dataC_electron[s].Histo1D(("sv_jet_pt_E","",50,0,25),"sv_jet_pt","weightSSOS")
      hist_dataC_sv_jet_eta_E = df_dataC_electron[s].Histo1D(("sv_jet_eta_E","",80,-4,4),"sv_jet_eta","weightSSOS")
      hist_dataC_sv_jet_mass_E = df_dataC_electron[s].Histo1D(("sv_jet_mass_E","",50,0,5),"sv_jet_mass","weightSSOS")
      hist_dataC_sv_jet_pangle_E = df_dataC_electron[s].Histo1D(("sv_jet_pangle_E","",50,1,3.5),"sv_jet_pangle","weightSSOS")
      hist_dataC_sv_jet_chi_E = df_dataC_electron[s].Histo1D(("sv_jet_chi_E","",50,0,20),"sv_jet_chi","weightSSOS")
      hist_dataC_sv_jet_ndof_E = df_dataC_electron[s].Histo1D(("sv_jet_ndof_E","",10,0,10),"sv_jet_ndof","weightSSOS")
      hist_dataC_sv_jet_charge_E = df_dataC_electron[s].Histo1D(("sv_jet_charge_E","",10,-5,5),"sv_jet_charge","weightSSOS")
      hist_dataC_sv_jet_ntracks_E = df_dataC_electron[s].Histo1D(("sv_jet_ntracks_E","",15,0,15),"sv_jet_ntracks","weightSSOS")
      hist_dataC_sv_jet_relpt_E = df_dataC_electron[s].Histo1D(("sv_jet_relpt_E","",50,0,1),"sv_jet_relpt","weightSSOS")
      hist_dataC_sv_max_pt_E = df_dataC_electron[s].Histo1D(("sv_max_pt_E","",50,0,25),"sv_max_pt","weightSSOS")
      hist_dataC_sv_max_eta_E = df_dataC_electron[s].Histo1D(("sv_max_eta_E","",80,-4,4),"sv_max_eta","weightSSOS")
      hist_dataC_sv_max_mass_E = df_dataC_electron[s].Histo1D(("sv_max_mass_E","",50,0,5),"sv_max_mass","weightSSOS")
      hist_dataC_sv_max_pangle_E = df_dataC_electron[s].Histo1D(("sv_max_pangle_E","",50,1,3.5),"sv_max_pangle","weightSSOS")
      hist_dataC_sv_max_chi_E = df_dataC_electron[s].Histo1D(("sv_max_chi_E","",50,0,20),"sv_max_chi","weightSSOS")
      hist_dataC_sv_max_ndof_E = df_dataC_electron[s].Histo1D(("sv_max_ndof_E","",10,0,10),"sv_max_ndof","weightSSOS")
      hist_dataC_sv_max_charge_E = df_dataC_electron[s].Histo1D(("sv_max_charge_E","",10,-5,5),"sv_max_charge","weightSSOS")
      hist_dataC_sv_max_ntracks_E = df_dataC_electron[s].Histo1D(("sv_max_ntracks_E","",15,0,15),"sv_max_ntracks","weightSSOS")
      hist_dataC_InvM_2jets_E = df_dataC_electron[s].Histo1D(("InvM_2jets_E","",100,0,300),"InvM_2jets","weightSSOS")
      hist_dataC_InvM_jetM_lep_E = df_dataC_electron[s].Histo1D(("InvM_jetM_lepE","",100,0,300),"InvM_jetM_lep","weightSSOS")
      hist_dataC_MET_E = df_dataC_electron[s].Histo1D(("MET_pt_E","",100,0,150),"MET_pt","weightSSOS")
      hist_dataC_deltaR_jetM_lep_E = df_dataC_electron[s].Histo1D(("deltaR_jetM_lepE","",100,0,5),"deltaR_jetM_lepE","weightSSOS")
      ...
      hist_dataC_tranverse_mass_E = df_dataC_electron[s].Histo1D(("transverse_massE","",50,0,150),"transverse_mass","weightSSOS")
      ...
      hist_dataC_sv_jet_sigxy_E = df_dataC_electron[s].Histo1D(("sv_jet_sigxy_E","",100,-4,4),"sv_jet_sigxy","weightSSOS")
      hist_dataC_sv_jet_sigr_E = df_dataC_electron[s].Histo1D(("sv_jet_sigr_E","",100,3,30),"sv_jet_sigr","weightSSOS")
      hist_dataC_sv_jet_xy_E = df_dataC_electron[s].Histo1D(("sv_jet_xy_E","",100,-4,4),"sv_jet_xy","weightSSOS")
      hist_dataC_sv_jet_r_E = df_dataC_electron[s].Histo1D(("sv_jet_r_E","",100,0,6),"sv_jet_r","weightSSOS")
      hist_dataC_sv_max_sigxy_E = df_dataC_electron[s].Histo1D(("sv_max_sigxy_E","",100,-4,4),"sv_max_sigxy","weightSSOS")
      hist_dataC_sv_max_sigr_E = df_dataC_electron[s].Histo1D(("sv_max_sigr_E","",100,3,30),"sv_max_sigr","weightSSOS")
      hist_dataC_sv_max_xy_E = df_dataC_electron[s].Histo1D(("sv_max_xy_E","",100,-4,4),"sv_max_xy","weightSSOS")
      hist_dataC_sv_max_r_E = df_dataC_electron[s].Histo1D(("sv_max_r_E","",100,0,6),"sv_max_r","weightSSOS")
      hist_dataC_SSOS_E = df_dataC_electron[s].Histo1D(("SSOS_E","",6,-3,3),"SVLepSign","weightSSOS")
      ...
      hist_dataC_jet_muon_btag_E = df_dataC_electron[s].Histo1D(("jet_sv_btag_E","",50,0,1),"jet_muon_btag","weightSSOS")
      hist_dataC_jet_notmuon_btag_E = df_dataC_electron[s].Histo1D(("jet_notsv_btag_E","",50,0,1),"jet_notmuon_btag","weightSSOS")
      hist_dataC_pT_proy_E = df_dataC_electron[s].Histo1D(("pT_proy_E","",100,-100,100),"pT_proy","weightSSOS")
      hist_dataC_pT_sum_2J_E = df_dataC_electron[s].Histo1D(("pT_sum 2J_E","",100,0,1),"pT_sum_2J","weightSSOS")
...
hist_mcC_sv_jet_pt_M = {}
hist_mcC_sv_jet_eta_M = {}
hist_mcC_sv_jet_mass_M = {}
hist_mcC_sv_jet_pangle_M = {}
hist_mcC_sv_jet_chi_M = {}
hist_mcC_sv_jet_ndof_M = {}
hist_mcC_sv_jet_ntracks_M = {}
hist_mcC_sv_jet_charge_M = {}
hist_mcC_sv_jet_pt_E = {}
hist_mcC_sv_jet_eta_E = {}
hist_mcC_sv_jet_mass_E = {}
hist_mcC_sv_jet_pangle_E = {}
hist_mcC_sv_jet_chi_E = {}
hist_mcC_sv_jet_ndof_E = {}
hist_mcC_sv_jet_ntracks_E = {}
hist_mcC_sv_jet_charge_E = {}
hist_mcC_sv_jet_relpt_M = {}
hist_mcC_sv_jet_relpt_E = {}
hist_mcC_sv_max_pt_M = {}
hist_mcC_sv_max_eta_M = {}
hist_mcC_sv_max_mass_M = {}
hist_mcC_sv_max_pangle_M = {}
hist_mcC_sv_max_chi_M = {}
hist_mcC_sv_max_ndof_M = {}
hist_mcC_sv_max_ntracks_M = {}
hist_mcC_sv_max_charge_M = {}
hist_mcC_sv_max_pt_E = {}
hist_mcC_sv_max_eta_E = {}
hist_mcC_sv_max_mass_E = {}
hist_mcC_sv_max_pangle_E = {}
hist_mcC_sv_max_chi_E = {}
hist_mcC_sv_max_ndof_E = {}
hist_mcC_sv_max_ntracks_E = {}
hist_mcC_sv_max_charge_E = {}
...
hist_mcC_sv_jet_sigxy_M = {}
hist_mcC_sv_jet_sigxy_E = {}
hist_mcC_sv_jet_sigr_M = {}
hist_mcC_sv_jet_sigr_E = {}
hist_mcC_sv_jet_xy_M = {}
hist_mcC_sv_jet_xy_E = {}
hist_mcC_sv_jet_r_M = {}
hist_mcC_sv_jet_r_E = {}
hist_mcC_sv_max_sigxy_M = {}
hist_mcC_sv_max_sigxy_E = {}
hist_mcC_sv_max_sigr_M = {}
hist_mcC_sv_max_sigr_E = {}
hist_mcC_sv_max_xy_M = {}
hist_mcC_sv_max_xy_E = {}
hist_mcC_sv_max_r_M = {}
hist_mcC_sv_max_r_E = {}
hist_mcC_pT_sum_M = {}
hist_mcC_pT_sum_E = {}
...
for s in samples_mc:
	...
	hist_mcC_nSV_M[s] = df_mcC_muon[s].Histo1D(("nSV_M","",10,0,10),"nSV","weightSSOS")
	hist_mcC_nSV_E[s] = df_mcC_electron[s].Histo1D(("nSV_E","",10,0,10),"nSV","weightSSOS")
	...
	hist_mcC_jet_muon_pt_M[s] = df_mcC_muon[s].Histo1D(("jet_sv_pt_M","",50,20,120),"jet_muon_pt","weightSSOS")
	hist_mcC_jet_muon_nmu_M[s] = df_mcC_muon[s].Histo1D(("jet_sv_nmu_M","",10,0,10),"jet_muon_nmu","weightSSOS")
	hist_mcC_jet_notmuon_pt_M[s] = df_mcC_muon[s].Histo1D(("jet_not_sv_pt_M","",50,20,120),"jet_notmuon_pt","weightSSOS")
	hist_mcC_jet_muon_eta_M[s] = df_mcC_muon[s].Histo1D(("jet_sv_eta_M","",80,-4,4),"jet_muon_eta","weightSSOS")
	hist_mcC_jet_notmuon_eta_M[s] = df_mcC_muon[s].Histo1D(("jet_not_sv_eta_M","",80,-4,4),"jet_notmuon_eta","weightSSOS")
	hist_mcC_jet_notmuon_nmu_M[s] = df_mcC_muon[s].Histo1D(("jet_notsv_nmu_M","",10,0,10),"jet_notmuon_nmu","weightSSOS")
	hist_mcC_jet_notmuon_mass_M[s] = df_mcC_muon[s].Histo1D(("jet_notsv_mass_M","",40,0,40),"jet_notmuon_mass","weightSSOS")
	hist_mcC_jet_notmuon_qgl_M[s] = df_mcC_muon[s].Histo1D(("jet_notsv_qgl_M","",100,0,1),"jet_notmuon_qgl","weightSSOS")

	hist_mcC_jet_muon_pt_E[s] = df_mcC_electron[s].Histo1D(("jet_sv_pt_E","",50,20,120),"jet_muon_pt","weightSSOS")
	hist_mcC_jet_muon_nmu_E[s] = df_mcC_electron[s].Histo1D(("jet_sv_nmu_E","",10,0,10),"jet_muon_nmu","weightSSOS")
	hist_mcC_jet_notmuon_pt_E[s] = df_mcC_electron[s].Histo1D(("jet_not_sv_pt_E","",50,20,120),"jet_notmuon_pt","weightSSOS")
	hist_mcC_jet_muon_eta_E[s] = df_mcC_electron[s].Histo1D(("jet_sv_eta_E","",80,-4,4),"jet_muon_eta","weightSSOS")
	hist_mcC_jet_notmuon_eta_E[s] = df_mcC_electron[s].Histo1D(("jet_not_sv_eta_E","",80,-4,4),"jet_notmuon_eta","weightSSOS")
	hist_mcC_jet_notmuon_nmu_E[s] = df_mcC_electron[s].Histo1D(("jet_notsv_nmu_E","",10,0,10),"jet_notmuon_nmu","weightSSOS")
	hist_mcC_jet_notmuon_mass_E[s] = df_mcC_electron[s].Histo1D(("jet_notsv_mass_E","",40,0,40),"jet_notmuon_mass","weightSSOS")
	hist_mcC_jet_notmuon_qgl_E[s] = df_mcC_electron[s].Histo1D(("jet_notsv_qgl_E","",100,0,1),"jet_notmuon_qgl","weightSSOS")
	...
	hist_mcC_sv_jet_pt_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_pt_M","",50,0,25),"sv_jet_pt","weightSSOS")
	hist_mcC_sv_jet_eta_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_eta_M","",80,-4,4),"sv_jet_eta","weightSSOS")
	hist_mcC_sv_jet_mass_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_mass_M","",50,0,5),"sv_jet_mass","weightSSOS")
	hist_mcC_sv_jet_pangle_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_pangle_M","",50,1,3.5),"sv_jet_pangle","weightSSOS")
	hist_mcC_sv_jet_chi_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_chi_M","",50,0,20),"sv_jet_chi","weightSSOS")
	hist_mcC_sv_jet_ndof_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_ndof_M","",10,0,10),"sv_jet_ndof","weightSSOS")
	hist_mcC_sv_jet_charge_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_charge_M","",10,-5,5),"sv_jet_charge","weightSSOS")

	hist_mcC_sv_jet_pt_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_pt_E","",50,0,25),"sv_jet_pt","weightSSOS")
	hist_mcC_sv_jet_eta_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_eta_E","",80,-4,4),"sv_jet_eta","weightSSOS")
	hist_mcC_sv_jet_mass_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_mass_E","",50,0,5),"sv_jet_mass","weightSSOS")
	hist_mcC_sv_jet_pangle_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_pangle_E","",50,1,3.5),"sv_jet_pangle","weightSSOS")
	hist_mcC_sv_jet_chi_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_chi_E","",50,0,20),"sv_jet_chi","weightSSOS")
	hist_mcC_sv_jet_ndof_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_ndof_E","",10,0,10),"sv_jet_ndof","weightSSOS")
	hist_mcC_sv_jet_charge_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_charge_E","",10,-5,5),"sv_jet_charge","weightSSOS")

	hist_mcC_sv_jet_ntracks_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_ntracks_M","",15,0,15),"sv_jet_ntracks","weightSSOS")
	hist_mcC_sv_jet_ntracks_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_ntracks_E","",15,0,15),"sv_jet_ntracks","weightSSOS")

	hist_mcC_sv_jet_relpt_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_relpt_M","",50,0,1),"sv_jet_relpt","weightSSOS")
	hist_mcC_sv_jet_relpt_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_relpt_E","",50,0,1),"sv_jet_relpt","weightSSOS")

	hist_mcC_sv_max_pt_M[s] = df_mcC_muon[s].Histo1D(("sv_max_pt_M","",50,0,25),"sv_max_pt","weightSSOS")
	hist_mcC_sv_max_eta_M[s] = df_mcC_muon[s].Histo1D(("sv_max_eta_M","",80,-4,4),"sv_max_eta","weightSSOS")
	hist_mcC_sv_max_mass_M[s] = df_mcC_muon[s].Histo1D(("sv_max_mass_M","",50,0,5),"sv_max_mass","weightSSOS")
	hist_mcC_sv_max_pangle_M[s] = df_mcC_muon[s].Histo1D(("sv_max_pangle_M","",50,1,3.5),"sv_max_pangle","weightSSOS")
	hist_mcC_sv_max_chi_M[s] = df_mcC_muon[s].Histo1D(("sv_max_chi_M","",50,0,20),"sv_max_chi","weightSSOS")
	hist_mcC_sv_max_ndof_M[s] = df_mcC_muon[s].Histo1D(("sv_max_ndof_M","",10,0,10),"sv_max_ndof","weightSSOS")
	hist_mcC_sv_max_charge_M[s] = df_mcC_muon[s].Histo1D(("sv_max_charge_M","",10,-5,5),"sv_max_charge","weightSSOS")

	hist_mcC_sv_max_pt_E[s] = df_mcC_electron[s].Histo1D(("sv_max_pt_E","",50,0,25),"sv_max_pt","weightSSOS")
	hist_mcC_sv_max_eta_E[s] = df_mcC_electron[s].Histo1D(("sv_max_eta_E","",80,-4,4),"sv_max_eta","weightSSOS")
	hist_mcC_sv_max_mass_E[s] = df_mcC_electron[s].Histo1D(("sv_max_mass_E","",50,0,5),"sv_max_mass","weightSSOS")
	hist_mcC_sv_max_pangle_E[s] = df_mcC_electron[s].Histo1D(("sv_max_pangle_E","",50,1,3.5),"sv_max_pangle","weightSSOS")
	hist_mcC_sv_max_chi_E[s] = df_mcC_electron[s].Histo1D(("sv_max_chi_E","",50,0,20),"sv_max_chi","weightSSOS")
	hist_mcC_sv_max_ndof_E[s] = df_mcC_electron[s].Histo1D(("sv_max_ndof_E","",10,0,10),"sv_max_ndof","weightSSOS")
	hist_mcC_sv_max_charge_E[s] = df_mcC_electron[s].Histo1D(("sv_max_charge_E","",10,-5,5),"sv_max_charge","weightSSOS")

	hist_mcC_sv_max_ntracks_M[s] = df_mcC_muon[s].Histo1D(("sv_max_ntracks_M","",15,0,15),"sv_max_ntracks","weightSSOS")
	hist_mcC_sv_max_ntracks_E[s] = df_mcC_electron[s].Histo1D(("sv_max_ntracks_E","",15,0,15),"sv_max_ntracks","weightSSOS")
	...
	hist_mcC_sv_jet_sigxy_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_sigxy_M","",100,-4,4),"sv_jet_sigxy","weightSSOS")
	hist_mcC_sv_jet_sigxy_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_sigxy_E","",100,-4,4),"sv_jet_sigxy","weightSSOS")

	hist_mcC_sv_jet_sigr_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_sigr_M","",100,3,30),"sv_jet_sigr","weightSSOS")
	hist_mcC_sv_jet_sigr_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_sigr_E","",100,3,30),"sv_jet_sigr","weightSSOS")

	hist_mcC_sv_jet_xy_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_xy_M","",100,-4,4),"sv_jet_xy","weightSSOS")
	hist_mcC_sv_jet_xy_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_xy_E","",100,-4,4),"sv_jet_xy","weightSSOS")

	hist_mcC_sv_jet_r_M[s] = df_mcC_muon[s].Histo1D(("sv_jet_r_M","",100,0,6),"sv_jet_r","weightSSOS")
	hist_mcC_sv_jet_r_E[s] = df_mcC_electron[s].Histo1D(("sv_jet_r_E","",100,0,6),"sv_jet_r","weightSSOS")

	hist_mcC_sv_max_sigxy_M[s] = df_mcC_muon[s].Histo1D(("sv_max_sigxy_M","",100,-4,4),"sv_max_sigxy","weightSSOS")
	hist_mcC_sv_max_sigxy_E[s] = df_mcC_electron[s].Histo1D(("sv_max_sigxy_E","",100,-4,4),"sv_max_sigxy","weightSSOS")

	hist_mcC_sv_max_sigr_M[s] = df_mcC_muon[s].Histo1D(("sv_max_sigr_M","",100,3,30),"sv_max_sigr","weightSSOS")
	hist_mcC_sv_max_sigr_E[s] = df_mcC_electron[s].Histo1D(("sv_max_sigr_E","",100,3,30),"sv_max_sigr","weightSSOS")

	hist_mcC_sv_max_xy_M[s] = df_mcC_muon[s].Histo1D(("sv_max_xy_M","",100,-4,4),"sv_max_xy","weightSSOS")
	hist_mcC_sv_max_xy_E[s] = df_mcC_electron[s].Histo1D(("sv_max_xy_E","",100,-4,4),"sv_max_xy","weightSSOS")

	hist_mcC_sv_max_r_M[s] = df_mcC_muon[s].Histo1D(("sv_max_r_M","",100,0,6),"sv_max_r","weightSSOS")
	hist_mcC_sv_max_r_E[s] = df_mcC_electron[s].Histo1D(("sv_max_r_E","",100,0,6),"sv_max_r","weightSSOS")

	hist_mcC_SSOS_M[s] = df_mcC_muon[s].Histo1D(("SSOS_M","",6,-3,3),"SVLepSign","weightSSOS")
	hist_mcC_SSOS_E[s] = df_mcC_electron[s].Histo1D(("SSOS_E","",6,-3,3),"SVLepSign","weightSSOS")
	...
	hist_mcC_jet_muon_btag_M[s] = df_mcC_muon[s].Histo1D(("jet_sv_btag_M","",50,0,1),"jet_muon_btag","weightSSOS")
	hist_mcC_jet_muon_btag_E[s] = df_mcC_electron[s].Histo1D(("jet_sv_btag_E","",50,0,1),"jet_muon_btag","weightSSOS")
	hist_mcC_jet_notmuon_btag_M[s] = df_mcC_muon[s].Histo1D(("jet_notsv_btag_M","",50,0,1),"jet_notmuon_btag","weightSSOS")
	hist_mcC_jet_notmuon_btag_E[s] = df_mcC_electron[s].Histo1D(("jet_notsv_btag_E","",50,0,1),"jet_notmuon_btag","weightSSOS")
	...
	hist_mcC_pT_sum_2J_M[s] = df_mcC_muon[s].Histo1D(("pT_sum 2J_M","",100,0,1),"pT_sum_2J","weightSSOS")
	hist_mcC_pT_sum_2J_E[s] = df_mcC_electron[s].Histo1D(("pT_sum 2J_E","",100,0,1),"pT_sum_2J","weightSSOS")
...
for s in samples_mc:
	...
	hist_mcC_nSV_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_nSV_E[s].Scale(lumiD/lumi_mc[s])
	...
	hist_mcC_sv_jet_pt_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_eta_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_mass_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_pangle_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_chi_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_ndof_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_charge_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_pt_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_eta_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_mass_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_pangle_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_chi_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_ndof_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_charge_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_ntracks_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_ntracks_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_relpt_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_relpt_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_pt_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_eta_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_mass_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_pangle_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_chi_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_ndof_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_charge_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_pt_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_eta_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_mass_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_pangle_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_chi_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_ndof_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_charge_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_ntracks_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_ntracks_E[s].Scale(lumiD/lumi_mc[s])
	...
	hist_mcC_sv_jet_sigxy_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_sigxy_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_sigr_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_sigr_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_xy_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_xy_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_r_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_jet_r_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_sigxy_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_sigxy_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_sigr_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_sigr_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_xy_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_xy_E[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_r_M[s].Scale(lumiD/lumi_mc[s])
	hist_mcC_sv_max_r_E[s].Scale(lumiD/lumi_mc[s])
...
for s in samples_mc:
   if s[0]+s[1]+s[2]+s[3]+s[4] == "Wjets":   
        ...
        hist_mcC_nSV_M[s].Scale(CoefWJ_M[years])
        hist_mcC_nSV_E[s].Scale(CoefWJ_E[years])
        ...
        hist_mcC_sv_jet_pt_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_eta_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_mass_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_pangle_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_chi_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_ndof_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_charge_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_pt_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_eta_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_mass_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_pangle_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_chi_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_ndof_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_charge_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_ntracks_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_ntracks_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_relpt_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_relpt_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_pt_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_eta_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_mass_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_pangle_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_chi_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_ndof_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_charge_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_pt_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_eta_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_mass_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_pangle_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_chi_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_ndof_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_charge_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_ntracks_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_ntracks_E[s].Scale(CoefWJ_E[years])
        ...
        hist_mcC_sv_jet_sigxy_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_sigxy_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_sigr_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_sigr_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_xy_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_xy_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_jet_r_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_jet_r_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_sigxy_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_sigxy_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_sigr_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_sigr_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_xy_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_xy_E[s].Scale(CoefWJ_E[years])
        hist_mcC_sv_max_r_M[s].Scale(CoefWJ_M[years])
        hist_mcC_sv_max_r_E[s].Scale(CoefWJ_E[years])
...
h_nSV_MCC_M = hist_mcC_nSV_M[samples_mc[0]]
h_nSV_MCC_E = hist_mcC_nSV_E[samples_mc[0]]
...
h_sv_jet_pt_MCC_M = hist_mcC_sv_jet_pt_M[samples_mc[0]]
h_sv_jet_eta_MCC_M = hist_mcC_sv_jet_eta_M[samples_mc[0]]
h_sv_jet_mass_MCC_M = hist_mcC_sv_jet_mass_M[samples_mc[0]]
h_sv_jet_pangle_MCC_M = hist_mcC_sv_jet_pangle_M[samples_mc[0]]
h_sv_jet_chi_MCC_M = hist_mcC_sv_jet_chi_M[samples_mc[0]]
h_sv_jet_ndof_MCC_M = hist_mcC_sv_jet_ndof_M[samples_mc[0]]
h_sv_jet_charge_MCC_M = hist_mcC_sv_jet_charge_M[samples_mc[0]]
h_sv_jet_pt_MCC_E = hist_mcC_sv_jet_pt_E[samples_mc[0]]
h_sv_jet_eta_MCC_E = hist_mcC_sv_jet_eta_E[samples_mc[0]]
h_sv_jet_mass_MCC_E = hist_mcC_sv_jet_mass_E[samples_mc[0]]
h_sv_jet_pangle_MCC_E = hist_mcC_sv_jet_pangle_E[samples_mc[0]]
h_sv_jet_chi_MCC_E = hist_mcC_sv_jet_chi_E[samples_mc[0]]
h_sv_jet_ndof_MCC_E = hist_mcC_sv_jet_ndof_E[samples_mc[0]]
h_sv_jet_charge_MCC_E = hist_mcC_sv_jet_charge_E[samples_mc[0]]
h_sv_jet_ntracks_MCC_M = hist_mcC_sv_jet_ntracks_M[samples_mc[0]]
h_sv_jet_ntracks_MCC_E = hist_mcC_sv_jet_ntracks_E[samples_mc[0]]
h_sv_jet_relpt_MCC_M = hist_mcC_sv_jet_relpt_M[samples_mc[0]]
h_sv_jet_relpt_MCC_E = hist_mcC_sv_jet_relpt_E[samples_mc[0]]
h_sv_max_pt_MCC_M = hist_mcC_sv_max_pt_M[samples_mc[0]]
h_sv_max_eta_MCC_M = hist_mcC_sv_max_eta_M[samples_mc[0]]
h_sv_max_mass_MCC_M = hist_mcC_sv_max_mass_M[samples_mc[0]]
h_sv_max_pangle_MCC_M = hist_mcC_sv_max_pangle_M[samples_mc[0]]
h_sv_max_chi_MCC_M = hist_mcC_sv_max_chi_M[samples_mc[0]]
h_sv_max_ndof_MCC_M = hist_mcC_sv_max_ndof_M[samples_mc[0]]
h_sv_max_charge_MCC_M = hist_mcC_sv_max_charge_M[samples_mc[0]]
h_sv_max_pt_MCC_E = hist_mcC_sv_max_pt_E[samples_mc[0]]
h_sv_max_eta_MCC_E = hist_mcC_sv_max_eta_E[samples_mc[0]]
h_sv_max_mass_MCC_E = hist_mcC_sv_max_mass_E[samples_mc[0]]
h_sv_max_pangle_MCC_E = hist_mcC_sv_max_pangle_E[samples_mc[0]]
h_sv_max_chi_MCC_E = hist_mcC_sv_max_chi_E[samples_mc[0]]
h_sv_max_ndof_MCC_E = hist_mcC_sv_max_ndof_E[samples_mc[0]]
h_sv_max_charge_MCC_E = hist_mcC_sv_max_charge_E[samples_mc[0]]
h_sv_max_ntracks_MCC_M = hist_mcC_sv_max_ntracks_M[samples_mc[0]]
h_sv_max_ntracks_MCC_E = hist_mcC_sv_max_ntracks_E[samples_mc[0]]
h_InvM_2jets_MCC_M = hist_mcC_InvM_2jets_M[samples_mc[0]]
h_InvM_2jets_MCC_E = hist_mcC_InvM_2jets_E[samples_mc[0]]
h_InvM_jetM_lep_MCC_M = hist_mcC_InvM_jetM_lepM[samples_mc[0]]
h_InvM_jetM_lep_MCC_E = hist_mcC_InvM_jetM_lepE[samples_mc[0]]
h_MET_MCC_M = hist_mcC_MET_M[samples_mc[0]]
h_MET_MCC_E = hist_mcC_MET_E[samples_mc[0]]
h_deltaR_jetM_lep_MCC_M = hist_mcC_deltaR_jetM_lepM[samples_mc[0]]
h_deltaR_jetM_lep_MCC_E = hist_mcC_deltaR_jetM_lepE[samples_mc[0]]
...
h_tranverse_mass_MCC_M = hist_mcC_tranverse_massM[samples_mc[0]]
h_tranverse_mass_MCC_E = hist_mcC_tranverse_massE[samples_mc[0]]
...
h_sv_jet_sigxy_MCC_M = hist_mcC_sv_jet_sigxy_M[samples_mc[0]]
h_sv_jet_sigxy_MCC_E = hist_mcC_sv_jet_sigxy_E[samples_mc[0]]
h_sv_jet_sigr_MCC_M = hist_mcC_sv_jet_sigr_M[samples_mc[0]]
h_sv_jet_sigr_MCC_E = hist_mcC_sv_jet_sigr_E[samples_mc[0]]
h_sv_jet_xy_MCC_M = hist_mcC_sv_jet_xy_M[samples_mc[0]]
h_sv_jet_xy_MCC_E = hist_mcC_sv_jet_xy_E[samples_mc[0]]
h_sv_jet_r_MCC_M = hist_mcC_sv_jet_r_M[samples_mc[0]]
h_sv_jet_r_MCC_E = hist_mcC_sv_jet_r_E[samples_mc[0]]
...
for s in samples_mc:
  if s != samples_mc[0]:
      ...
      h_nSV_MCC_M.Add(hist_mcC_nSV_M[s].GetPtr())
      h_nSV_MCC_E.Add(hist_mcC_nSV_E[s].GetPtr())
      ...
      h_sv_jet_pt_MCC_M.Add(hist_mcC_sv_jet_pt_M[s].GetPtr())
      h_sv_jet_eta_MCC_M.Add(hist_mcC_sv_jet_eta_M[s].GetPtr())
      h_sv_jet_mass_MCC_M.Add(hist_mcC_sv_jet_mass_M[s].GetPtr())
      h_sv_jet_pangle_MCC_M.Add(hist_mcC_sv_jet_pangle_M[s].GetPtr())
      h_sv_jet_chi_MCC_M.Add(hist_mcC_sv_jet_chi_M[s].GetPtr())
      h_sv_jet_ndof_MCC_M.Add(hist_mcC_sv_jet_ndof_M[s].GetPtr())
      h_sv_jet_charge_MCC_M.Add(hist_mcC_sv_jet_charge_M[s].GetPtr())
      h_sv_jet_pt_MCC_E.Add(hist_mcC_sv_jet_pt_E[s].GetPtr())
      h_sv_jet_eta_MCC_E.Add(hist_mcC_sv_jet_eta_E[s].GetPtr())
      h_sv_jet_mass_MCC_E.Add(hist_mcC_sv_jet_mass_E[s].GetPtr())
      h_sv_jet_pangle_MCC_E.Add(hist_mcC_sv_jet_pangle_E[s].GetPtr())
      h_sv_jet_chi_MCC_E.Add(hist_mcC_sv_jet_chi_E[s].GetPtr())
      h_sv_jet_ndof_MCC_E.Add(hist_mcC_sv_jet_ndof_E[s].GetPtr())
      h_sv_jet_charge_MCC_E.Add(hist_mcC_sv_jet_charge_E[s].GetPtr())
      h_sv_jet_ntracks_MCC_M.Add(hist_mcC_sv_jet_ntracks_M[s].GetPtr())
      h_sv_jet_ntracks_MCC_E.Add(hist_mcC_sv_jet_ntracks_E[s].GetPtr())
      h_sv_jet_relpt_MCC_M.Add(hist_mcC_sv_jet_relpt_M[s].GetPtr())
      h_sv_jet_relpt_MCC_E.Add(hist_mcC_sv_jet_relpt_E[s].GetPtr())
      h_sv_max_pt_MCC_M.Add(hist_mcC_sv_max_pt_M[s].GetPtr())
      h_sv_max_eta_MCC_M.Add(hist_mcC_sv_max_eta_M[s].GetPtr())
      h_sv_max_mass_MCC_M.Add(hist_mcC_sv_max_mass_M[s].GetPtr())
      h_sv_max_pangle_MCC_M.Add(hist_mcC_sv_max_pangle_M[s].GetPtr())
      h_sv_max_chi_MCC_M.Add(hist_mcC_sv_max_chi_M[s].GetPtr())
      h_sv_max_ndof_MCC_M.Add(hist_mcC_sv_max_ndof_M[s].GetPtr())
      h_sv_max_charge_MCC_M.Add(hist_mcC_sv_max_charge_M[s].GetPtr())
      h_sv_max_pt_MCC_E.Add(hist_mcC_sv_max_pt_E[s].GetPtr())
      h_sv_max_eta_MCC_E.Add(hist_mcC_sv_max_eta_E[s].GetPtr())
      h_sv_max_mass_MCC_E.Add(hist_mcC_sv_max_mass_E[s].GetPtr())
      h_sv_max_pangle_MCC_E.Add(hist_mcC_sv_max_pangle_E[s].GetPtr())
      h_sv_max_chi_MCC_E.Add(hist_mcC_sv_max_chi_E[s].GetPtr())
      h_sv_max_ndof_MCC_E.Add(hist_mcC_sv_max_ndof_E[s].GetPtr())
      h_sv_max_charge_MCC_E.Add(hist_mcC_sv_max_charge_E[s].GetPtr())
      h_sv_max_ntracks_MCC_M.Add(hist_mcC_sv_max_ntracks_M[s].GetPtr())
      h_sv_max_ntracks_MCC_E.Add(hist_mcC_sv_max_ntracks_E[s].GetPtr())
      h_InvM_2jets_MCC_M.Add(hist_mcC_InvM_2jets_M[s].GetPtr())
      h_InvM_2jets_MCC_E.Add(hist_mcC_InvM_2jets_E[s].GetPtr())
      h_InvM_jetM_lep_MCC_M.Add(hist_mcC_InvM_jetM_lepM[s].GetPtr())
      h_InvM_jetM_lep_MCC_E.Add(hist_mcC_InvM_jetM_lepE[s].GetPtr())
      h_MET_MCC_M.Add(hist_mcC_MET_M[s].GetPtr())
      h_MET_MCC_E.Add(hist_mcC_MET_E[s].GetPtr())
      h_deltaR_jetM_lep_MCC_M.Add(hist_mcC_deltaR_jetM_lepM[s].GetPtr())
      h_deltaR_jetM_lep_MCC_E.Add(hist_mcC_deltaR_jetM_lepE[s].GetPtr())
      ...
      h_tranverse_mass_MCC_M.Add(hist_mcC_tranverse_massM[s].GetPtr())
      h_tranverse_mass_MCC_E.Add(hist_mcC_tranverse_massE[s].GetPtr())
      ...
      h_sv_jet_sigxy_MCC_M.Add(hist_mcC_sv_jet_sigxy_M[s].GetPtr())
      h_sv_jet_sigxy_MCC_E.Add(hist_mcC_sv_jet_sigxy_E[s].GetPtr())
      h_sv_jet_sigr_MCC_M.Add(hist_mcC_sv_jet_sigr_M[s].GetPtr())
      h_sv_jet_sigr_MCC_E.Add(hist_mcC_sv_jet_sigr_E[s].GetPtr())
      h_sv_jet_xy_MCC_M.Add(hist_mcC_sv_jet_xy_M[s].GetPtr())
      h_sv_jet_xy_MCC_E.Add(hist_mcC_sv_jet_xy_E[s].GetPtr())
      h_sv_jet_r_MCC_M.Add(hist_mcC_sv_jet_r_M[s].GetPtr())
      h_sv_jet_r_MCC_E.Add(hist_mcC_sv_jet_r_E[s].GetPtr())
...
hist_dataC_nSV_M.Add(h_nSV_MCC_M.GetPtr(),-1)
hist_dataC_nSV_E.Add(h_nSV_MCC_E.GetPtr(),-1)
...
hist_dataC_sv_jet_pt_M.Add(h_sv_jet_pt_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_eta_M.Add(h_sv_jet_eta_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_mass_M.Add(h_sv_jet_mass_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_pangle_M.Add(h_sv_jet_pangle_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_chi_M.Add(h_sv_jet_chi_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_ndof_M.Add(h_sv_jet_ndof_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_charge_M.Add(h_sv_jet_charge_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_pt_E.Add(h_sv_jet_pt_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_eta_E.Add(h_sv_jet_eta_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_mass_E.Add(h_sv_jet_mass_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_pangle_E.Add(h_sv_jet_pangle_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_chi_E.Add(h_sv_jet_chi_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_ndof_E.Add(h_sv_jet_ndof_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_charge_E.Add(h_sv_jet_charge_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_ntracks_M.Add(h_sv_jet_ntracks_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_ntracks_E.Add(h_sv_jet_ntracks_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_relpt_M.Add(h_sv_jet_relpt_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_relpt_E.Add(h_sv_jet_relpt_MCC_E.GetPtr(),-1)
hist_dataC_sv_max_pt_M.Add(h_sv_max_pt_MCC_M.GetPtr(),-1)
hist_dataC_sv_max_eta_M.Add(h_sv_max_eta_MCC_M.GetPtr(),-1)
hist_dataC_sv_max_mass_M.Add(h_sv_max_mass_MCC_M.GetPtr(),-1)
hist_dataC_sv_max_pangle_M.Add(h_sv_max_pangle_MCC_M.GetPtr(),-1)
hist_dataC_sv_max_chi_M.Add(h_sv_max_chi_MCC_M.GetPtr(),-1)
hist_dataC_sv_max_ndof_M.Add(h_sv_max_ndof_MCC_M.GetPtr(),-1)
hist_dataC_sv_max_charge_M.Add(h_sv_max_charge_MCC_M.GetPtr(),-1)
hist_dataC_sv_max_pt_E.Add(h_sv_max_pt_MCC_E.GetPtr(),-1)
hist_dataC_sv_max_eta_E.Add(h_sv_max_eta_MCC_E.GetPtr(),-1)
hist_dataC_sv_max_mass_E.Add(h_sv_max_mass_MCC_E.GetPtr(),-1)
hist_dataC_sv_max_pangle_E.Add(h_sv_max_pangle_MCC_E.GetPtr(),-1)
hist_dataC_sv_max_chi_E.Add(h_sv_max_chi_MCC_E.GetPtr(),-1)
hist_dataC_sv_max_ndof_E.Add(h_sv_max_ndof_MCC_E.GetPtr(),-1)
hist_dataC_sv_max_charge_E.Add(h_sv_max_charge_MCC_E.GetPtr(),-1)
hist_dataC_sv_max_ntracks_M.Add(h_sv_max_ntracks_MCC_M.GetPtr(),-1)
hist_dataC_sv_max_ntracks_E.Add(h_sv_max_ntracks_MCC_E.GetPtr(),-1)
hist_dataC_InvM_2jets_M.Add(h_InvM_2jets_MCC_M.GetPtr(),-1)
hist_dataC_InvM_2jets_E.Add(h_InvM_2jets_MCC_E.GetPtr(),-1)
hist_dataC_InvM_jetM_lep_M.Add(h_InvM_jetM_lep_MCC_M.GetPtr(),-1)
hist_dataC_InvM_jetM_lep_E.Add(h_InvM_jetM_lep_MCC_E.GetPtr(),-1)
hist_dataC_MET_M.Add(h_MET_MCC_M.GetPtr(),-1)
hist_dataC_MET_E.Add(h_MET_MCC_E.GetPtr(),-1)
hist_dataC_deltaR_jetM_lep_M.Add(h_deltaR_jetM_lep_MCC_M.GetPtr(),-1)
hist_dataC_deltaR_jetM_lep_E.Add(h_deltaR_jetM_lep_MCC_E.GetPtr(),-1)
...
hist_dataC_tranverse_mass_M.Add(h_tranverse_mass_MCC_M.GetPtr(),-1)
hist_dataC_tranverse_mass_E.Add(h_tranverse_mass_MCC_E.GetPtr(),-1)
...
hist_dataC_sv_jet_sigxy_M.Add(h_sv_jet_sigxy_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_sigxy_E.Add(h_sv_jet_sigxy_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_sigr_M.Add(h_sv_jet_sigr_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_sigr_E.Add(h_sv_jet_sigr_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_xy_M.Add(h_sv_jet_xy_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_xy_E.Add(h_sv_jet_xy_MCC_E.GetPtr(),-1)
hist_dataC_sv_jet_r_M.Add(h_sv_jet_r_MCC_M.GetPtr(),-1)
hist_dataC_sv_jet_r_E.Add(h_sv_jet_r_MCC_E.GetPtr(),-1)
...
hist_dataC_nJetGood_M.Scale(0.32821)
hist_dataC_nJetGood_E.Scale(0.13548)
hist_dataC_nSV_M.Scale(0.32821)
hist_dataC_nSV_E.Scale(0.13548)
hist_dataC_nMuoninJet_M.Scale(0.32821)
hist_dataC_nMuoninJet_E.Scale(0.13548)
hist_dataC_jet_muon_pt_M.Scale(0.32821)
hist_dataC_jet_muon_nmu_M.Scale(0.32821)
hist_dataC_jet_notmuon_pt_M.Scale(0.32821)
hist_dataC_jet_muon_eta_M.Scale(0.32821)
hist_dataC_jet_notmuon_eta_M.Scale(0.32821)
hist_dataC_jet_notmuon_nmu_M.Scale(0.32821)
hist_dataC_jet_notmuon_mass_M.Scale(0.32821)
hist_dataC_jet_notmuon_qgl_M.Scale(0.32821)
hist_dataC_jet_muon_pt_E.Scale(0.13548)
hist_dataC_jet_muon_nmu_E.Scale(0.13548)
hist_dataC_jet_notmuon_pt_E.Scale(0.13548)
hist_dataC_jet_muon_eta_E.Scale(0.13548)
hist_dataC_jet_notmuon_eta_E.Scale(0.13548)
hist_dataC_jet_notmuon_nmu_E.Scale(0.13548)
hist_dataC_jet_notmuon_mass_E.Scale(0.13548)
hist_dataC_jet_notmuon_qgl_E.Scale(0.13548)
hist_dataC_lepton_pt_M.Scale(0.32821)
hist_dataC_lepton_eta_M.Scale(0.32821)
hist_dataC_lepton_pt_E.Scale(0.13548)
hist_dataC_lepton_eta_E.Scale(0.13548)
hist_dataC_sv_jet_pt_M.Scale(0.32821)
hist_dataC_sv_jet_eta_M.Scale(0.32821)
hist_dataC_sv_jet_mass_M.Scale(0.32821)
hist_dataC_sv_jet_pangle_M.Scale(0.32821)
hist_dataC_sv_jet_chi_M.Scale(0.32821)
hist_dataC_sv_jet_ndof_M.Scale(0.32821)
hist_dataC_sv_jet_charge_M.Scale(0.32821)
hist_dataC_sv_jet_pt_E.Scale(0.13548)
hist_dataC_sv_jet_eta_E.Scale(0.13548)
hist_dataC_sv_jet_mass_E.Scale(0.13548)
hist_dataC_sv_jet_pangle_E.Scale(0.13548)
hist_dataC_sv_jet_chi_E.Scale(0.13548)
hist_dataC_sv_jet_ndof_E.Scale(0.13548)
hist_dataC_sv_jet_charge_E.Scale(0.13548)
hist_dataC_sv_jet_ntracks_M.Scale(0.32821)
hist_dataC_sv_jet_ntracks_E.Scale(0.13548)
hist_dataC_sv_jet_relpt_M.Scale(0.32821)
hist_dataC_sv_jet_relpt_E.Scale(0.13548)
hist_dataC_sv_max_pt_M.Scale(0.32821)
hist_dataC_sv_max_eta_M.Scale(0.32821)
hist_dataC_sv_max_mass_M.Scale(0.32821)
hist_dataC_sv_max_pangle_M.Scale(0.32821)
hist_dataC_sv_max_chi_M.Scale(0.32821)
hist_dataC_sv_max_ndof_M.Scale(0.32821)
hist_dataC_sv_max_charge_M.Scale(0.32821)
hist_dataC_sv_max_pt_E.Scale(0.13548)
hist_dataC_sv_max_eta_E.Scale(0.13548)
hist_dataC_sv_max_mass_E.Scale(0.13548)
hist_dataC_sv_max_pangle_E.Scale(0.13548)
hist_dataC_sv_max_chi_E.Scale(0.13548)
hist_dataC_sv_max_ndof_E.Scale(0.13548)
hist_dataC_sv_max_charge_E.Scale(0.13548)
hist_dataC_sv_max_ntracks_M.Scale(0.32821)
hist_dataC_sv_max_ntracks_E.Scale(0.13548)
hist_dataC_InvM_2jets_M.Scale(0.32821)
hist_dataC_InvM_2jets_E.Scale(0.13548)
hist_dataC_InvM_jetM_lep_M.Scale(0.32821)
hist_dataC_InvM_jetM_lep_E.Scale(0.13548)
hist_dataC_MET_M.Scale(0.32821)
hist_dataC_MET_E.Scale(0.13548)
hist_dataC_deltaR_jetM_lep_M.Scale(0.32821)
hist_dataC_deltaR_jetM_lep_E.Scale(0.13548)
hist_dataC_deltaR_jetM_jetNM_M.Scale(0.32821)
hist_dataC_deltaR_jetM_jetNM_E.Scale(0.13548)
hist_dataC_deltaphi_jetM_jetNM_M.Scale(0.32821)
hist_dataC_deltaphi_jetM_jetNM_E.Scale(0.13548)
hist_dataC_deltaeta_jetM_jetNM_M.Scale(0.32821)
hist_dataC_deltaeta_jetM_jetNM_E.Scale(0.13548)
hist_dataC_deltapt_jetM_jetNM_M.Scale(0.32821)
hist_dataC_deltapt_jetM_jetNM_E.Scale(0.13548)
hist_dataC_tranverse_mass_M.Scale(0.32821)
hist_dataC_tranverse_mass_E.Scale(0.13548)
hist_dataC_tracks_jetM_M.Scale(0.32821)
hist_dataC_tracks_jetNM_M.Scale(0.32821)
hist_dataC_tracks_jetM_E.Scale(0.13548)
hist_dataC_tracks_jetNM_E.Scale(0.13548)
hist_dataC_EMN_jetM_M.Scale(0.32821)
hist_dataC_EMC_jetM_M.Scale(0.32821)
hist_dataC_EMN_jetM_E.Scale(0.13548)
hist_dataC_EMC_jetM_E.Scale(0.13548)
hist_dataC_EMtotal_jetM_M.Scale(0.32821)
hist_dataC_EMtotal_jetM_E.Scale(0.13548)
hist_dataC_sv_jet_sigxy_M.Scale(0.32821)
hist_dataC_sv_jet_sigxy_E.Scale(0.13548)
hist_dataC_sv_jet_sigr_M.Scale(0.32821)
hist_dataC_sv_jet_sigr_E.Scale(0.13548)
hist_dataC_sv_jet_xy_M.Scale(0.32821)
hist_dataC_sv_jet_xy_E.Scale(0.13548)
hist_dataC_sv_jet_r_M.Scale(0.32821)
hist_dataC_sv_jet_r_E.Scale(0.13548)
hist_dataC_SSOS_M.Scale(0.32821)
hist_dataC_SSOS_E.Scale(0.13548)
hist_dataC_lepton_iso_E.Scale(0.13548)
hist_dataC_lepton_mva_E.Scale(0.13548)
hist_dataC_pT_sum_M.Scale(0.32821)
hist_dataC_pT_sum_E.Scale(0.13548)
hist_dataC_pT_product_M.Scale(0.32821)
hist_dataC_pT_product_E.Scale(0.13548)
hist_dataC_deltaR_lep_2jets_M.Scale(0.32821)
hist_dataC_deltaR_lep_2jets_E.Scale(0.13548)
hist_dataC_deltaphi_MET_2jets_M.Scale(0.32821)
hist_dataC_deltaphi_MET_2jets_E.Scale(0.13548)
hist_dataC_deltaphi_lephad_M.Scale(0.32821)
hist_dataC_deltaphi_lephad_E.Scale(0.13548)
hist_dataC_eta_2jets_M.Scale(0.32821)
hist_dataC_eta_2jets_E.Scale(0.13548)
hist_dataC_pt_2jets_M.Scale(0.32821)
hist_dataC_pt_2jets_E.Scale(0.13548)
hist_dataC_pt_Wlep_M.Scale(0.32821)
hist_dataC_pt_Wlep_E.Scale(0.13548)
hist_dataC_deltaR_lephad_M.Scale(0.32821)
hist_dataC_deltaR_lephad_E.Scale(0.13548)
hist_dataC_deltaphi_lep_2jets_M.Scale(0.32821)
hist_dataC_deltaphi_lep_2jets_E.Scale(0.13548)
hist_dataC_deltaeta_lephad_M.Scale(0.32821)
hist_dataC_deltaeta_lephad_E.Scale(0.13548)
hist_dataC_deltaeta_lep_2jets_M.Scale(0.32821)
hist_dataC_deltaeta_lep_2jets_E.Scale(0.13548)
hist_dataC_deltapt_lephad_M.Scale(0.32821)
hist_dataC_deltapt_lephad_E.Scale(0.13548)
hist_dataC_deltapt_lep_2jets_M.Scale(0.32821)
hist_dataC_deltapt_lep_2jets_E.Scale(0.13548)
hist_dataC_jet_muon_btag_M.Scale(0.32821)
hist_dataC_jet_muon_btag_E.Scale(0.13548)
hist_dataC_jet_notmuon_btag_M.Scale(0.32821)
hist_dataC_jet_notmuon_btag_E.Scale(0.13548)
hist_dataC_pT_proy_M.Scale(0.32821)
hist_dataC_pT_proy_E.Scale(0.13548)
hist_dataC_pT_sum_2J_M.Scale(0.32821)
hist_dataC_pT_sum_2J_E.Scale(0.13548)

if args.ssos: path_hist = '/nfs/cms/vazqueze/analisisWW/hists/SV/ssos/cuts/sv_v1v3v5SSOS_QCD'+years+'.root'
else: path_hist = '/nfs/cms/vazqueze/analisisWW/hists/SV/cuts/sv_v1v3v5_QCD'+years+'.root'
myfile = TFile( path_hist, 'RECREATE' )

hist_dataC_nJetGood_M.Write()
hist_dataC_nJetGood_E.Write()
hist_dataC_nSV_M.Write()
hist_dataC_nSV_E.Write()
...
hist_dataC_sv_jet_pt_M.Write()
hist_dataC_sv_jet_eta_M.Write()
hist_dataC_sv_jet_mass_M.Write()
hist_dataC_sv_jet_pangle_M.Write()
hist_dataC_sv_jet_chi_M.Write()
hist_dataC_sv_jet_ndof_M.Write()
hist_dataC_sv_jet_charge_M.Write()
hist_dataC_sv_jet_pt_E.Write()
hist_dataC_sv_jet_eta_E.Write()
hist_dataC_sv_jet_mass_E.Write()
hist_dataC_sv_jet_pangle_E.Write()
hist_dataC_sv_jet_chi_E.Write()
hist_dataC_sv_jet_ndof_E.Write()
hist_dataC_sv_jet_charge_E.Write()
hist_dataC_sv_jet_ntracks_M.Write()
hist_dataC_sv_jet_ntracks_E.Write()
hist_dataC_sv_jet_relpt_M.Write()
hist_dataC_sv_jet_relpt_E.Write()
hist_dataC_sv_max_pt_M.Write()
hist_dataC_sv_max_eta_M.Write()
hist_dataC_sv_max_mass_M.Write()
hist_dataC_sv_max_pangle_M.Write()
hist_dataC_sv_max_chi_M.Write()
hist_dataC_sv_max_ndof_M.Write()
hist_dataC_sv_max_charge_M.Write()
hist_dataC_sv_max_pt_E.Write()
hist_dataC_sv_max_eta_E.Write()
hist_dataC_sv_max_mass_E.Write()
hist_dataC_sv_max_pangle_E.Write()
hist_dataC_sv_max_chi_E.Write()
hist_dataC_sv_max_ndof_E.Write()
hist_dataC_sv_max_charge_E.Write()
hist_dataC_sv_max_ntracks_M.Write()
hist_dataC_sv_max_ntracks_E.Write()
hist_dataC_InvM_2jets_M.Write()
hist_dataC_InvM_2jets_E.Write()
hist_dataC_InvM_jetM_lep_M.Write()
hist_dataC_InvM_jetM_lep_E.Write()
hist_dataC_MET_M.Write()
hist_dataC_MET_E.Write()
hist_dataC_deltaR_jetM_lep_M.Write()
hist_dataC_deltaR_jetM_lep_E.Write()
...
hist_dataC_tranverse_mass_M.Write()
hist_dataC_tranverse_mass_E.Write()
...
hist_dataC_sv_jet_sigxy_M.Write()
hist_dataC_sv_jet_sigxy_E.Write()
hist_dataC_sv_jet_sigr_M.Write()
hist_dataC_sv_jet_sigr_E.Write()
hist_dataC_sv_jet_xy_M.Write()
hist_dataC_sv_jet_xy_E.Write()
hist_dataC_sv_jet_r_M.Write()
hist_dataC_sv_jet_r_E.Write()
